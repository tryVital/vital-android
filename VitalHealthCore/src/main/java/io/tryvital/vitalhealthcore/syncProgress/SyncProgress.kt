...
data class SyncProgress(
    ...
    enum class SystemEventType(override val rawValue: Int): RawIntRepresentable {
        ...
        companion object {
            fun of(value: Int): SystemEventType = values().first { it.rawValue == value }
        }
    }
    ...
    enum class SyncStatus(override val rawValue: Int): RawIntRepresentable {
        ...
        companion object {
            fun of(value: Int): SyncStatus = values().first { it.rawValue == value }
        }
    }
    ...
    enum class SyncContextTag(override val rawValue: Int): RawIntRepresentable {
        ...
        companion object {
            fun of(value: Int): SyncContextTag = values().first { it.rawValue == value }
        }
    }
}
